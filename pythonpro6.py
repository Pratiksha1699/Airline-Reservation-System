...
imgbadd=tk2.PhotoImage(file="img\\btn10_2.png")
...
def view():
    ...
    for i in rows:
        admin=i[0]
        lblad=tk2.Label(can,bg='purple',text=admin,font='Arial 15 bold',fg='white')
        lblad.place(x=j,y=k,width=120,height=50)
        j=j+130
        count=count+1
        if(count==3):
            k=k+100
...
def add():
     ...
     Name=tk2.Label(root5,bg='purple',text='Enter ADMIN name:',font='Arial 10')
     ...
     Name=tk2.Label(root5,bg='purple',text='Enter password:',font='Arial 10')
     ...
     addadmin=tk2.Button(root5,image=imgbadd,text="ADD ADMIN",compound="center",bd=0,bg='#1a75c2',font="Arial 13 bold",activebackground='#1a75c2',highlightthickness=0,command=adminadd)
     addadmin.place(x=200,y=230,width=170,height=40)
...
B2.place(x=400,y=100,width=170,height=60)
...
close.place(x=650,y=10,width=30,height=30)
